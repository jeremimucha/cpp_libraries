// example 8a -- server utilising async_write and async_receive_some
#include <iostream>
...
int main()
{
    ...
    boost::shared_ptr< tcp::acceptor > acceptor( new tcp::acceptor( *io_service ) );
    ...
    try{
        ...
        acceptor->async_accept( *sock, boost::bind( OnAccept,
